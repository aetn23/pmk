...
def main():
    ...
    for line in stm32_dev:
        if (line[0] == '0' or line[0] == '1') and (line.__len__() == 10 ):
            val = int(line[0:8], 2)
            ...
            x_val = 0 
            y_val = 0
            if (final_val > 0 and final_val < 9) or (final_val < 0 and final_val >-9):
                final_val = 0
...
#            final_val *= 2
            if line[8] == 'x':
                ...
                y_val = final_val
            mouse.move(y_val, x_val, absolute=False, duration=0);
